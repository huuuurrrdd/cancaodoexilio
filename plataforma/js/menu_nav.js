...
let mazeScript = document.createElement('script');

// Adicionar o conteúdo do script
mazeScript.textContent = `
(function (m, a, z, e) {
  var s, t, u, v;
  try {
...
})(window, document, 'https://snippet.maze.co/maze-universal-loader.js', '89600cfa-b4fc-428b-b0cd-d45fd9f5e9c7');
`;
